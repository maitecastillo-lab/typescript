...
# he utilizado inteface porque tengo datos más robustos, claros y poder definir el tipo que sera, ya que, un solo type no seria correcto seleccionar para los tipos de datos
# tambien porque si en el futuro quiero agregar más datos, no seria problema alguno.
